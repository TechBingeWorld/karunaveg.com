        ...
        <div class="container-fluid col-11">
          <div
            ...
            <div class="mb-3 mb-md-0">
              <h4>Videos </h4>
              <!-- <p>Watch Latest Videos Blogs by Karunaveg</p> -->
            </div>
            <div class="page_link">
      ...
      <div class="container-fluid col-11">
          <div class="row">
              <div class="col-lg-9 mb-5 mb-lg-0">
                  ...
                  <!-- If user has come from all-section page by clicking on view_all button then 
                        below given same category videos will be seen -->
                  <?php
                  ...
                  <div class="blog_right_sidebar">
                        ...
                        <h4 class="widget_title">Categories</h4>
                          ...
                          ?>
                            ...
                            <ul class="list cat-list">
                                <li>
                                    <a href="videos.php?category_id=<?= $row['id']?>" class="d-flex">
                      ...
                      <aside class="single_sidebar_widget popular_post_widget">
                          ...
                          <div class="media post_item">
                             <img src="uploaded_images/<?= getPostThumb($db,$row['id'])?>" id="blog-img" class=""  alt="<?php
                                $alt= str_replace(' ', '-', ( $row['title'])); echo$alt?>" style="width: 50px; height: 40px;">   
