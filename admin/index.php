...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?all_books">
          <i class="bi bi-card-list"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?add_book">
          <i class="bi bi-card-list"></i>
          <span>Add Book</span>
        </a>
      </li>
...
////////////////////////////////////////////////////////////////////////////////////////////
  ...
  elseif(isset($_GET['manage_video_blogs']))
  {
  ...
  elseif(isset($_GET['all_books']))
  {

        // <!-- career -->
        include('../includes/all-books.php');
        // <!-- career -->
                      ...
                      <form  method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group">
                          ...
                          <div class="col-sm-12 mb-3">
                            ...
                            <textarea class="form-control text-truncate" name="video_description" rows="6" ><?php echo $data['description'];?></textarea>
                          </div>
                        </div>
                          <div class="col-sm-12 mb-3">
                            <label>(url)</label>
                      ...
                      <form action="../includes/update-post.php?id=$id" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="col-sm-12 mb-3">
                          <label>Post Content</label>,
                            <textarea class="form-control ckeditor" value="<?php echo $data['content'];?>"  name="post_content" rows="6" ></textarea>
                          </div>
                        </div>
