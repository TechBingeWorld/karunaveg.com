  ...
  <nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid ">
      <!-- <a class="navbar-brand" href="index.html"><h2>Karuna veg </h2></a> -->
        <a class="navbar-brand" href="index.php" ><img src="assets/images/Karunaveg-logo1.png" style="width :80px; height: 50px; padding:0; margin:0" alt="karuna-veg-logo" srcset=""></a>
